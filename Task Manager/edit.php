...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="Task_Manager.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="Task_Manager.php">Add/Edit Task</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container my-4">
    ...
    <form action="Task_Manager.php<?php echo isset($id) ? '?id=' . $id : ''; ?>" method="POST">
        <div class="mb-3">
