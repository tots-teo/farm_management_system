...
class User {
    ...
    public function updateUser($userId, $firstName, $lastName, $email, $phone, $gender, $profileImagePath) {
        $stmt = $this->conn->prepare("
            UPDATE users 
            SET first_name = ?, last_name = ?, email = ?, phone = ?, gender = ?, profile_pic = ? 
            WHERE id = ?
        ");
        $stmt->bind_param('ssssssi', $firstName, $lastName, $email, $phone, $gender, $profileImagePath, $userId);
